"""
Base agent classes for Scotland Yard game.

This module defines the abstract base classes for agents that can play Scotland Yard.
...
class Agent(ABC):
    """Abstract base class for all Scotland Yard agents"""
...
class MrXAgent(Agent):
    ...
    def can_use_double_move(self, game: ScotlandYardGame) -> bool:
...
class MultiDetectiveAgent(Agent):
    ...
    def make_move(self, game: ScotlandYardGame) -> List[Tuple[int, TransportType]]:
